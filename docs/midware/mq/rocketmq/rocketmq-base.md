...
命名服务充当路由消息的提供者。生产者或消费者能够通过命名服务查找各主题相应的Broker IP列表。多个Namesrv实例组成集群，但相互独立，没有信息交换。
...
![消息存储架构图](pic/rocketmq-pic01.png)
...
| 线程数 | 线程名                         | 线程具体说明            |
| -------- | -------------------------------- | ------------------------- |
| 1      | NettyBoss*%d*                  | Reactor 主线程          |
| N      | NettyServerEPOLLSelector%d*%d* | Reactor 线程池          |
| M1     | NettyServerCodecThread%d       | Worker线程池            |
...
![consumeQueue存储结构](pic/rocketmq-pic07.png)
...
![事务消息 图1](pic/rocketmq-pic10.png)
...
![事务消息 图2](pic/rocketmq-pic11.png)
...
![事务消息 图3](pic/rocketmq-pic12.png)
...
![查询消息 图1](pic/rocketmq-pic13.png)
